<template>
<uni-shadow-root class="vant-dist-circle-index"><view class="van-circle">
...
global['__wxRoute'] = 'vant/dist/circle/index'
...
export default global['__wxComponents']['vant/dist/circle/index']
</script>
