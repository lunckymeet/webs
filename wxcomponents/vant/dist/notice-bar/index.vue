<template>
<uni-shadow-root class="vant-dist-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = 'vant/dist/notice-bar/index'
...
export default global['__wxComponents']['vant/dist/notice-bar/index']
</script>
