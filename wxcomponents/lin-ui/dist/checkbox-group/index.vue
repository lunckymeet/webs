<template>
<uni-shadow-root class="lin-ui-dist-checkbox-group-index"><view :class="'l-class checkbox-group checkbox-group-'+(placement)">
  <slot></slot> 
</view>
...
import LCheckbox from '../checkbox/index.vue'
global['__wxVueOptions'] = {components:{'l-error-tip': LErrorTip,'l-checkbox': LCheckbox}}

global['__wxRoute'] = 'lin-ui/dist/checkbox-group/index'
...
export default global['__wxComponents']['lin-ui/dist/checkbox-group/index']
</script>
