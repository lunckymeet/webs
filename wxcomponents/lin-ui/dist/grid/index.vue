<template>
<uni-shadow-root class="lin-ui-dist-grid-index"><view class="l-grid l-class" @click="tapGrid">
...
global['__wxRoute'] = 'lin-ui/dist/grid/index'
...
export default global['__wxComponents']['lin-ui/dist/grid/index']
</script>
