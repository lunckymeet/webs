<template>
<uni-shadow-root class="lin-ui-dist-radio-group-index"><view :class="'l-class radio-group radio-group-'+(placement)">
    <slot></slot>
</view>
...
import LRadio from '../radio/index.vue'
global['__wxVueOptions'] = {components:{'l-error-tip': LErrorTip,'l-radio': LRadio}}

global['__wxRoute'] = 'lin-ui/dist/radio-group/index'
...
export default global['__wxComponents']['lin-ui/dist/radio-group/index']
</script>
