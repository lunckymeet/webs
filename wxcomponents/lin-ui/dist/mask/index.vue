<template>
<uni-shadow-root class="lin-ui-dist-mask-index"><view :class="'container-mask '+(center? 'center' : '')+' l-class'" :hidden="show? '' :  'hidden'" @touchmove.stop.prevent="doNothingMove" @click.stop.prevent="onMaskTap" :style="'z-index:'+(zIndex)+'; '+(show? 'background: rgba(0,0,0,' + opacity+ ')' :  '')">
...
global['__wxRoute'] = 'lin-ui/dist/mask/index'
...
export default global['__wxComponents']['lin-ui/dist/mask/index']
</script>
