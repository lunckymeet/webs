<template>
<uni-shadow-root class="lin-ui-dist-form-index"><view class="l-form-container-class">
    <slot></slot>
</view>
<view class="l-form-btn-class">
    <slot name="submit-front"></slot>
    <view class="l-form-submit-class" @click.capture="submit">
        <slot name="submit"></slot>
    </view>
    <slot name="reset-front"></slot>
    <view class="l-form-reset-class" @click.capture="reset">
        <slot name="reset"></slot>
    </view>
    <slot name="reset-behind"></slot>
...
global['__wxRoute'] = 'lin-ui/dist/form/index'
...
export default global['__wxComponents']['lin-ui/dist/form/index']
</script>
