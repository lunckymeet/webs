<template>
<uni-shadow-root class="lin-ui-dist-input-index"><label :class="'form-item '+(disabled? "disabled": "")+' l-class form-item-'+(labelLayout)" :style="'width:'+(width===null?'auto':width+'rpx')">
  ...
  <input v-if="type !== 'password'" :class="'input '+(hideLabel?'hideLabel':'')+' l-input-class'" :value="value" :type="type" :placeholder="placeholder" :maxlength="maxlength" placeholder-class="pls-class" :placeholder-style="placeholderStyle" :disabled="disabled" :focus="focus" @input="handleInputChange" @focus="handleInputFocus" @blur="handleInputBlur" @confirm="handleInputConfirm"></input>
...
global['__wxRoute'] = 'lin-ui/dist/input/index'
...
export default global['__wxComponents']['lin-ui/dist/input/index']
</script>
