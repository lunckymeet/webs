<template>
<uni-shadow-root class="lin-ui-dist-transition-index"><view v-if="inited" :class="'l-transition l-class '+(classes)" :style="'-webkit-transition-duration:'+(currentDuration)+'ms; transition-duration:'+(currentDuration)+'ms; '+(display ? '' : 'display: none;')+' '+(customStyle)" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = 'lin-ui/dist/transition/index'
...
export default global['__wxComponents']['lin-ui/dist/transition/index']
</script>
