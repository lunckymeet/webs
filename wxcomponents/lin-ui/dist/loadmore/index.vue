<template>
<uni-shadow-root class="lin-ui-dist-loadmore-index"><slot name="content"></slot>
...
global['__wxRoute'] = 'lin-ui/dist/loadmore/index'
...
export default global['__wxComponents']['lin-ui/dist/loadmore/index']
</script>
